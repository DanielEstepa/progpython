...
class Aplicacion:
    def __init__(self):
        ...
        self.check3=tk.Checkbutton(self.ventana1,text="Opera", variable=self.seleccion3)
        self.check3.grid(column=0, row=2)
        self.check4=tk.Checkbutton(self.ventana1,text="Edge", variable=self.seleccion1)
